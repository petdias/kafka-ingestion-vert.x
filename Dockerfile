...
# Maven & Dependencias #
########################
FROM registry.cmpn.paas.gsnetcloud.corp/santander/javase-8:2.0.0.RELEASE as DEPENDENCIES
...
## APLICACAO ##
###############
FROM registry.cmpn.paas.gsnetcloud.corp/santander/javase-8:2.0.0.RELEASE
ARG APP_PATH
ARG NAME
ARG VERSION
